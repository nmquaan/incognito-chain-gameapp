...
var PHASER_PLUGIN_9SLIDE = './node_modules/phaser3-nineslice/dist/'
...
function copyPhaser() {
    ...
    srcList = srcList.map(function(file) {
        console.log('File %s', PHASER_PATH + file);
...
function copyPhaserPlugin() {

    var srcList = ['nineslice.min.js'];
    
    srcList = srcList.map(function(file) {
        console.log('File %s', PHASER_PLUGIN_9SLIDE + file);
        return PHASER_PLUGIN_9SLIDE + file;
    });
...
gulp.task('copyPhaserPlugin', ['copyPhaser'], copyPhaserPlugin);
gulp.task('build', ['copyPhaserPlugin'], build);
